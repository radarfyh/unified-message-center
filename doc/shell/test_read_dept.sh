...
messageId="f312da59404fc19430ab160f4c664798"                  # 替换为要上报的消息ID（从拉取结果中获取）
receiverId="6d7d266f226911f197e7000c2926aaa4"                # 替换为接收者ID（从拉取结果中的 receiverId 字段获取）
receiverType="DEPT"                          # 接收者类型：USER（个人）或 DEPT（部门）
broadcastId="a90b2cd3afecde26e7c8d6cdccc9f0a5"                               # 如果是广播消息，填写广播ID，否则留空
...
curl -X POST "$baseUrl/ump/open/message/read" \
