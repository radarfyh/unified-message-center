		...
		<div class="mt-4 flex items-center justify-center text-sm">
			<div class="px-4 py-2 bg-gray-50 dark:bg-gray-800 rounded-full transition-all">
				<div class="text-gray-700 dark:text-gray-300">
                    ...
                    <#else>
						<a href="https://hunting-info.ltd" class="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium transition-colors">
                            ${principalName}
						</a>
                    </#if>
				</div>
