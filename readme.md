...
5. **启动 redis 和 springboot admin**
   ...
   - 微服务监控管理端要访问 `http://127.0.0.1:12006`，默认用户名/密码：admin/123456
...
- **GitHub 地址**：[https://github.com/radarfyh/unified-message-center](https://github.com/radarfyh/unified-message-center)
...
![二维码](doc/dev-manual/qrcode_1774166869361.jpg)
